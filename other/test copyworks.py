...
# Flattening the nested list of offers
flat_offers = [item for sublist in offers for item in sublist]

# Creating a DataFrame
df_offers = pd.DataFrame(flat_offers)

# Extracting outcomes
df_outcomes = pd.DataFrame(df_offers['outcomes'].explode().tolist())
df_offers.to_csv("ofers.csv")
